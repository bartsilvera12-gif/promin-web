...
// ---- Analítica de visitas (privacidad: sin IP completa, sin datos personales) ----
// Se registra una vez por carga de página, en reposo y sin bloquear. Si el
// endpoint falla, la página no se ve afectada. El panel admin nunca se rastrea.
let __visitTracked = false;
export function trackVisit() {
  if (__visitTracked) return;
  __visitTracked = true;
  try {
